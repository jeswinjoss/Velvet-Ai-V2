...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "text-white bg-gradient-to-r from-brand-500 to-brand-700 hover:from-brand-400 hover:to-brand-600 shadow-[0_0_20px_rgba(14,165,233,0.3)] focus:ring-brand-500 border border-transparent",
